set_age_comp = function(input, age_comp)
{
  ...
  if(is.null(age_comp)){
    ...
    if(is.character(age_comp)){ # all use the same model
      ...
      themod <- match(age_comp, c("multinomial","dir-mult","dirichlet","logistic-normal-01-infl","logistic-normal-pool0","logistic-normal-01-infl-2par","logistic-normal-miss0","mvtweedie"))
      ...
      if(all(names(age_comp) == c("fleets","indices"))){
        ...
        themods <- match(age_comp$fleets, c("multinomial","dir-mult","dirichlet","logistic-normal-01-infl","logistic-normal-pool0","logistic-normal-01-infl-2par","logistic-normal-miss0","mvtweedie"))
        ...
        themods <- match(age_comp$indices, c("multinomial","dir-mult","dirichlet","logistic-normal-01-infl","logistic-normal-pool0","logistic-normal-01-infl-2par","logistic-normal-miss0","mvtweedie"))
  ...
  data$n_age_comp_pars_fleets = c(0,1,1,3,1,2,1,2)[data$age_comp_model_fleets]
  data$n_age_comp_pars_indices = c(0,1,1,3,1,2,1,2)[data$age_comp_model_indices]
  ...
  n_catch_acomp_pars = c(0,1,1,3,1,2,1,2)[data$age_comp_model_fleets[which(apply(data$use_catch_paa,2,sum)>0)]]
  n_index_acomp_pars = c(0,1,1,3,1,2,1,2)[data$age_comp_model_indices[which(apply(data$use_index_paa,2,sum)>0)]]
